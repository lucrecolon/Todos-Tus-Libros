...
export const BookDetails = () => {
    ...
    // --- MAGIA ---
    // 1. Cruzamos los datos de la API con nuestro JSON local
    ...
    // 2. Filtramos las que no tienen stock (así limpiamos el HTML de abajo)
    const libreriasConStock = libreriasConDistancia.filter(l => l.stock > 0);

    // 3. Ordenamos: las más cercanas arriba (las que no tienen distancia van al fondo)
        ...
        <>
            ...
            <div className="main-container">
                ...
                <div className="bookstores-list">
                    ...
                    {/* ACÁ USAMOS NUESTRA NUEVA LISTA ORDENADA */}
                        ...
                        libreriasOrdenadas.map((tienda, index) => (
                            <div className="store-card" key={index}>
                                <div className="store-info">
                                    ...
                                    {/* Mostramos la dirección que sacamos del JSON */}
                                    <p style={{ margin: '5px 0', fontSize: '14px', color: 'var(--text-muted)' }}>
                                        {tienda.direccionInfo}
                                    </p>
                                    
                                    {/* Si calculó la distancia, la mostramos en verde */}
